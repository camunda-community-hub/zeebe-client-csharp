...
public interface IEvaluateDecisionCommandStep1
{
  ...
  public interface IEvaluateDecisionCommandStep2 : IFinalCommandWithRetryStep<IEvaluateDecisionResponse>, ITenantIdCommandStep<IEvaluateDecisionCommandStep2>
  {
      /// <summary>
