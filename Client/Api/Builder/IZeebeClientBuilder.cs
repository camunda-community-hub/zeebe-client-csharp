...
public interface IZeebeClientFinalBuildStep
{
    ...
    ///     <p>
    ///         This is an optional configuration. Per default the wait time provider provides base two wait time,
    ///         2^1 seconds, 2^2 seconds, 2^3 seconds etc. until one minute is reached.
    ///     </p>
    /// </summary>
